...
[5. 客戶分群分析 (Audience Segmentation)](#5-客戶分群分析-Audience-Segmentation)
...
| **群組**    | **Recency（天）** | **Frequency** | **Monetary** | **再購機率 (%)** | **客戶特徵**         | **占比 (%)** | **預期行銷貢獻** | **行銷優先級** | **行銷策略建議**                                 |
| --------- | -------------- | ------------- | ------------ | ------------ | ---------------- | ---------- | ---------- | --------- | ------------------------------------------ |
| 0 | 214            | 2.89          | 149.60       | 90.79        | 高回購率、已多次購買、消費中等  | 42.46      | 提高客單價，提升獲利 | **高**     | - 推薦高價值商品組合<br>- 設計會員專屬福利與積分計畫<br>- 滿額折扣/升級優惠    |
| 1 | 272            | 1.53          | 175.05       | 73.48        | 低回購率、消費金額較高、流失風險 | 57.54      | 刺激回購，提高再購率 | **中**     | - 提供限時折扣、體驗包<br>- 精準推播 EDM/LINE 提醒<br>- 首次回購優惠活動 |
...
| 2 | 172.52         | 5.58          | 184.81       | 91.93        | 穩定回購、高再購機率、消費偏高  | 8.51       | 穩定高利潤貢獻    | **最高**    | - 提供 VIP 專屬優惠<br>- 推薦高價商品組合<br>- 建立長期會員計畫   |
| 3 | 86.69          | 2.38          | 2806.63      | 71.81        | 超高消費但回購率偏低       | 0.42       | 高單價潛力客戶    | **中**     | - 精準推薦高價產品<br>- 高價值客戶專屬服務<br>- 關係管理加強       |
| 4 | 206.44         | 2.24          | 143.57       | 90.65        | 回購頻率高、再購機率高、消費適中 | 31.38      | 穩定收入貢獻     | **高**     | - 推薦定期購方案<br>- 會員積分兌換促銷<br>- 提升單次消費額        |
